...
interface ModuleProps {
  /** Output JavaScript filename (defaults to `name` with .js file extension) */
  out?: string;
  /** Output WASM filename (defaults to `out` with .wasm file extension) */
  outwasm?: string;
  /** JavaScript entry file */
  jsentry?: string;
  /** Name used in generated ninja build file */
  name?: string;
...
interface LibProps {
  /** Input source files. Supports glob patterns. */
  sources: string | string[];
  /** name used in ninja comments */
  name?: string;
  /** additional cflags */
  cflags?: string[];
}
